...
- DE 交付: `Scriv/Data_Hub/扩展表建表.sql` + `扩展表_DE对接样例_v2.md`。库名 `sh_yb_platform` (原 TP_data_hub 已弃; 142 与 243 各一份, 142 侧 DE 共管)。
